  ...
  for (const file of files) {
    if (file !== '.DS_Store') {
      fs.readFile(`${path}/${file}`, function (err, data) {
        ...
        const uuid =
          json['cfdi:Complemento']['tfd:TimbreFiscalDigital']['UUID'];
        ...
        const fechaPago = json['cfdi:Complemento']['pago20:Pagos'][
          'pago20:Pago'
        ]['FechaPago'].replace('T', ' ');
        const fechaCreacion = json['cfdi:Complemento'][
